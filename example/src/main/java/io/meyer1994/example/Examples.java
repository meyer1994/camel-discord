...
public class Examples {
  ...
  /**
   * Queries the 20 nearest labeled examples and returns weighted good/bad scores
   * in the range
   * [0.0, 100.0]. Returns 50.0 for both when no examples exist.
   *
  ...
  public Score getScore(String embedding) {
    ...
    return jdbcTemplate.queryForObject(
        sql,
        (rs, rowNum) -> new Score(
            rs.getDouble("good_score"),
            rs.getDouble("bad_score")),
        embedding,
        embedding);
  }
