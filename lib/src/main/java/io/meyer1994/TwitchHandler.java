...
public class TwitchHandler {
  ...
  public void onChannelMessage(ChannelMessageEvent event) {
    ...
    exchange
        .getMessage()
        .setHeader(TwitchConstants.HEADER_CHANNEL_NAME, event.getChannel().getName());
    ...
    event
        ...
        .ifPresent(
            messageId ->
                exchange.getMessage().setHeader(TwitchConstants.HEADER_MESSAGE_ID, messageId));
  ...
  public void onEvent(Object event) {
    if (event instanceof StreamOnlineEvent streamOnline) {
      ...
      processEvent(
          event, "subscribe", subscribe, subscribe.getUserId(), subscribe.getUserName(), null);
  ...
  private void processEvent(
    ...
    exchange
        .getMessage()
        .setHeader(TwitchConstants.HEADER_CHANNEL_ID, channelEvent.getBroadcasterUserId());
    exchange
        .getMessage()
        .setHeader(TwitchConstants.HEADER_CHANNEL_NAME, channelEvent.getBroadcasterUserLogin());
    if (userId != null) {
